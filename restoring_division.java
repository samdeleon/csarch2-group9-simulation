        ...
        */
            ...
            */
			...
			if (i == 0) {
				if (mode == true) {
					...
					gui.textAreaOutput1.append("-STEP BY STEP-\n");
					gui.textAreaOutput1.append("INITIALIZATION--------\n");
		         	gui.textAreaOutput1.append("A:" + A + "\tQ:" + Q + "\n");
		         	gui.textAreaOutput1.append("M:" + M_divisor + "\t-M:" + M_compliment + "\n\n");

		         	// for text file output

				} else {
					gui.textAreaOutput2.setText("");
					gui.textAreaOutput2.append("-ALL-\n");
					gui.textAreaOutput2.append("INITIALIZATION--------\n");
		         	gui.textAreaOutput2.append("A:" + A + "\tQ:" + Q + "\n");
		         	gui.textAreaOutput2.append("M:" + M_divisor + "\t-M:" + M_compliment + "\n\n");
	    ...
	    if (mode == true) {
	       	...
	       	for (String str : steps) {
      			gui.textAreaOutput1.append(str);
   			}
     	} else {
	       	for (String str : steps) {
      			gui.textAreaOutput2.append(str);
    		}
        }
    }
